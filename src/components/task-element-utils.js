...
export default function createTaskElement(task) {
  ...
  const taskStringElement = `<li class="task" id="task-${task.index}">
        <input type="checkbox" name="check-${task.index}" id="check-${task.index}" ${task.completed ? 'checked' : null}>
        <label for="description" class="description">
          <input type="text" name="description" value="${task.description}" id="description-${task.index}">
        </label>
        <button type="button" class="icon move-button" id="moveButton-${task.index}">
          <i class="fa-solid fa-ellipsis-vertical"></i>
        </button>
        <button type="button" class="icon delete-button" id="deleteButton-${task.index}">
